  ...
  ),
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-destructive/12 text-destructive-ink shadow-[inset_0_0_0_1px_color-mix(in_oklab,var(--destructive)_28%,transparent)]",
        success:
          "bg-success/12 text-success-ink shadow-[inset_0_0_0_1px_color-mix(in_oklab,var(--success)_28%,transparent)]",
        warning:
          "bg-warning/15 text-warning-ink shadow-[inset_0_0_0_1px_color-mix(in_oklab,var(--warning)_32%,transparent)]",
